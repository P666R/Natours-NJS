...
if (userDataForm) addEventListener("submit", function(e) {
    e.preventDefault();
    ...
    var _ref = (0, _asyncToGenerator._)(function(name, email) {
        ...
        return (0, _tsGenerator._)(this, function(_state) {
            switch(_state.label){
                ...
                case 1:
                    res = _state.sent();
                    if (res.data.status === "success") (0, _alertsJs.showAlert)("success", "Data updated successfully");
                    return [
                        3,
                        3
                    ];
